...
(when window-system
  (add-hook 'emacs-lisp-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'lisp-interaction-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'java-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'c-mode-common-hook 'highlight-symbol-mode-on)
  (add-hook 'text-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'ruby-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'html-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'sh-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'Info-mode-hook 'highlight-symbol-mode-on)
  (add-hook 'perl-mode-hook 'highlight-symbol-mode-on))
...
(provide 'init-highlight-symbols)
